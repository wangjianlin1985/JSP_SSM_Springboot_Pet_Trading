		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#productOrderListPanel" aria-controls="productOrderListPanel" role="tab" data-toggle="tab">宠物订单列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ProductOrder/productOrder_frontAdd.jsp" style="display:none;">添加宠物订单</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>订单id</td><td>宠物信息</td><td>意向用户</td><td>意向出价</td><td>用户备注</td><td>下单时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<productOrderList.size();i++) {
					    	            		...
					    	            		ProductOrder productOrder = productOrderList.get(i); //获取到宠物订单对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productOrderQueryForm" id="productOrderQueryForm" action="<%=basePath %>ProductOrder/frontlist" class="mar_t15">
            <div class="form-group">
            	<label for="productSellObj_sellId">宠物信息：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;宠物订单信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="productOrder_productSellObj_sellId_edit" class="col-md-3 text-right">宠物信息:</label>
		  	 <div class="col-md-9">
