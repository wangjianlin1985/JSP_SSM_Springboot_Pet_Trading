...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">爱宠交易网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- <li><a href="<%=basePath %>ProductClass/frontlist">宠物类别</a></li> -->
                <li><a href="<%=basePath %>ProductSeek/frontlist">宠物求购</a></li>
                <li><a href="<%=basePath %>ProductSell/frontlist">宠物预售</a></li>
                <!-- 
                <li><a href="<%=basePath %>ProductOrder/frontlist">宠物订单</a></li> -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel"> 
                        <li><a href="<%=basePath %>ProductSeek/productSeek_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布宠物求购</a></li>
                        ...
                        <li><a href="<%=basePath %>ProductSell/productSell_frontUserAdd.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;发布预售宠物</a></li>
