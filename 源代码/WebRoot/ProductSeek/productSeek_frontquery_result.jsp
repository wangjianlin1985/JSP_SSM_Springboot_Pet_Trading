			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>ProductSeek/<%=productSeek.getSeekId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=productSeek.getProductPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		宠物名称:<%=productSeek.getProductName() %>
			     	</div>
			     	<div class="field">
	            		宠物类别:<%=productSeek.getProductClassObj().getProductClassName() %>
			     	</div>
			     	<div class="field">
	            		交易地点:<%=productSeek.getPublish() %>
			     	</div>
			     	<div class="field">
	            		宠物品种:<%=productSeek.getAuthor() %>
			     	</div>
			     	<div class="field">
	            		求购价格:<%=productSeek.getPrice() %>
			     	</div>
			     	<div class="field">
	            		宠物年龄:<%=productSeek.getXjcd() %>
			     	</div>
			     	<div class="field">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="productSeek_publish_edit" class="col-md-3 text-right">交易地点:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productSeek_publish_edit" name="productSeek.publish" class="form-control" placeholder="请输入交易地点">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="productSeek_author_edit" class="col-md-3 text-right">宠物品种:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productSeek_author_edit" name="productSeek.author" class="form-control" placeholder="请输入宠物品种">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="productSeek_xjcd_edit" class="col-md-3 text-right">宠物年龄:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productSeek_xjcd_edit" name="productSeek.xjcd" class="form-control" placeholder="请输入宠物年龄">
			 </div>
		  </div>
		  <div class="form-group">
